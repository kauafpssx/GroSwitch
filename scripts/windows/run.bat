...
if "%MODE%"=="prod" (
    ...
    echo [INFO]  Starting server on port 8400 from source...
    echo [INFO]  Frontend will be served from apps\frontend\dist\ if present
    echo.
    call bun run apps/backend/src/server.ts
) else (
